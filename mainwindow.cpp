...
void MainWindow::on_toolButton_11_clicked()
{
    ...
    // Simple validation
    if (id.isEmpty() || nom.isEmpty() || type.isEmpty() || contact.isEmpty()) {
        QMessageBox::warning(this, "Validation", "Tous les champs sont obligatoires.");
        return;
    }
    ...
    Sponsor sponsor(id, nom, type, "", dateDebut, dateFin, contact);
    ...
    if (success) {
        ...
        QMessageBox::critical(this, "Erreur", "Échec de l'opération. Vérifiez les données.");
    }
}
