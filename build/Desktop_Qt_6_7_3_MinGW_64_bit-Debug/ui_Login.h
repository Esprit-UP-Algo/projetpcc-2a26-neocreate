...
"}"));
        ...
        label->setGeometry(QRect(30, 50, 91, 21));
...
"color:black;"));
    ...
    {
        Form->setWindowTitle(QCoreApplication::translate("Login", "Form", nullptr));
